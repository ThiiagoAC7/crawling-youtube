...
- [x] better error handling for when all api keys are used -> do this outside crawling.py
...
- [x] fix: when all api keys are used, progress is saved but current unfinished vid is marked as
true
...
- [x] fix: HttpError processingFailure -> add retries
